...
featured_image: "/blog/forbikjoring-og-feltskifte/forbikjoring-og-feltskifte-image.svg"
---
<style>
/* Base text styling */
.article-content {
...
![Forbikjøring og feltskifte oversikt](/blog/forbikjoring-og-feltskifte/forbikjoring-og-feltskifte-image.svg)
...
![Tillatte forbikjoringsituasjoner](/blog/forbikjoring-og-feltskifte/tillatte-forbikjoringsituasjoner.svg)
...
![Forbudte forbikjoringsituasjoner](/blog/forbikjoring-og-feltskifte/forbudte-forbikjoringsituasjoner.svg)
...
![Forbikjoringsteknikk](/blog/forbikjoring-og-feltskifte/forbikjoringsteknikk.svg)
...
| **70 km/t → 90 km/t** | 500-600 meter | Forbikjør lastebil |
 ...
 ![Forbikjoringsavstander](/blog/forbikjoring-og-feltskifte/forbikjoringsavstander.svg)
### Faktorer som øker nødvendig avstand
**Tilleggsavstand kreves** ved:
* **Dårlig akselerasjon** på egen bil
* **Tungt kjøretøy** som forbikjøres
* **Motvind** eller **slippstrøm** 
* **Våte eller glatte veier**
* **Flere kjøretøy** skal forbikjøres samlet
* **Redusert sikt** på grunn av vær
## Feltskifte - teknikk og regler
**Feltskifte** er en grunnleggende ferdighet som kreves daglig i moderne trafikk. Riktig teknikk er avgjørende for trafikksikkerheten.
### Grunnregler for feltskifte
**Trygt feltskifte** følger en systematisk prosedyre:
...
4. **Jevn og rolig manøver** - ikke brå bevegelser
![Feltskifte prosedyre](/blog/forbikjoring-og-feltskifte/feltskifte-prosedyre.svg)
### Speil-Signal-Skuldersjekk metoden
**Systematisk gjennomføring** sikrer trygg feltskifte:
#### 1. Speil (Mirror)
* **Backspeil** - oversikt over trafikk bak
* **Sidespeil** - trafikk i ønsket kjørefelt
* **Vurder hastighet** og avstand til andre kjøretøy
#### 2. Signal (Signal)
* **Blink i god tid** - minst 3-5 sekunder før
* **Hold blinkingen** til manøveren er fullført
* **Ikke blink for tidlig** på veier med flere avkjørsler
#### 3. Skuldersjekk (Shoulder check)
* **Rask blikk** over skulderen før du svinger
* **Sjekk blindsonen** som speilene ikke dekker
* **Bekreft fri passage** i ønsket kjørefelt
### Blindsoner og sikkerhet
**Blindsoner** er områder rundt bilen som ikke dekkes av speilene:
* **Høyre blindsone** - ca. 45 grader bak høyre side
* **Venstre blindsone** - ca. 45 grader bak venstre side
* **Bakre blindsone** - direkte bak bilen på kort avstand
* **Fremre blindsone** - ved store kjøretøy foran
![Blindsoner og speil](/blog/forbikjoring-og-feltskifte/blindsoner-og-speil.svg)
## Feltskifte i forskjellige situasjoner
### Motorvei og motortrafikkvei
**Feltskifte på motorveier** krever spesiell oppmerksomhet:
#### Påkjøring til motorvei:
* **Aksellerer i akselerasjonsfeltet** til motorveihastighet
* **Føyer deg inn** når det er trygg åpning
* **Ikke stopp** i akselerasjonsfeltet
* **Blink venstre** under innkjøring
#### Kjøring på motorvei:
* **Høyre felt** - normalkjøring og slower kjøretøy
* **Venstre felt** - kun for forbikjøring
* **Ikke "bo"** i venstre felt
* **Flytt tilbake** til høyre etter forbikjøring
...
![Motorvei feltskifte](/blog/forbikjoring-og-feltskifte/motorvei-feltskifte.svg)
...
![Forbikjoring av syklister](/blog/forbikjoring-og-feltskifte/forbikjoring-av-syklister.svg)
...
* **Ikke kjør tilbake** før du ser hele kjøretøyet
...
![Forbikjoring vinterfoere](/blog/forbikjoring-og-feltskifte/forbikjoring-vinterfoere.svg)
...
![Teknologi og sikkerhet](/blog/forbikjoring-og-feltskifte/teknologi-og-sikkerhet.svg)
...
![Vanlige feil forbikjoring](/blog/forbikjoring-og-feltskifte/vanlige-feil-forbikjoring.svg)
