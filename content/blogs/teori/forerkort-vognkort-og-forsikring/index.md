...
![Illustrasjon av Førerkort, vognkort og forsikring](forerkort-vognkort-og-forsikring-image.svg)
...
![Prosess for registrering av kjøretøy](registration-process.svg)
| Trinn | Beskrivelse |
|-------|-------------|
...
![Dokumentsjekkliste](doc-checklist.svg)
...
![Illustrasjon av prosess for å skaffe førerkort](license-process.svg)
...
![Oversikt over førerkortgyldighet](license-validity.svg)
...
![Illustrasjon av vognkortets to deler](vognkort-structure.svg)
...
| Avgiftstype | Beløp |
|-------------|-------|
| **Registreringsavgift** | Varierer etter vekt, alder og CO2-utslipp |
...
![Eierskifteprosess for vognkort](ownership-transfer.svg)
...
![Oversikt over forsikringstyper](insurance-types.svg)
